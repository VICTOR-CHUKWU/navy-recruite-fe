    ...
    return (
        ...
        <div className={`mt-3 w-full bg-white h-full pt-0 ${S.newHead}`} >
            <div className="container grid grid-cols-1 lg:grid-cols-2 gap-5 h-full">
                <div className={` w-full md:w-2/3 h-[30vh] ml-auto md:h-full flex flex-col justify-stretch`}>
                    <h1 className='text-center md:text-right mt-8 text-navy-blue text-3xl xl:text-6xl font-bold'>SERVING THE BRAVE</h1>
                ...
                <div className=' relative z-[3] pl-0 lg:pl-2'>
                    <div className=" hidden my-0 md:my-6 lg:grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
